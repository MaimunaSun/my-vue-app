...
export default {
  ...
  methods: {
    startGame() {
      // Set gameStarted to true before navigating to GameBoard
      this.$root.gameStarted = true;
      // Navigate to GameBoard route with player names as query parameters
      this.$router.push({ 
        name: 'GameBoard', 
        query: { 
...
.secondary-heading {
  ...
  margin-bottom: 150px; /* Increase space between heading and textboxes */
}
